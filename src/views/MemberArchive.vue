<template>
  <div class="download-page">
    ...
    <el-card class="info-card">
      <template #header>
        <div class="header-content">
          <div class="title-section">
            <span class="title">SNH48 GROUP 成员档案 APP</span>
      ...
      <div class="intro">
        <p>SNH48 GROUP 成员档案查询工具，方便随时查看成员资料，了解小偶像的详细信息。</p>
      </div>
...
const fetchVersions = async () => {
  try {
    const response = await fetch(`/apks/member_archive/version.json?t=${Date.now()}`)
    if (response.ok) {
